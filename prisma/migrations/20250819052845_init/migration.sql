...
-- AddForeignKey
ALTER TABLE "Image" ADD CONSTRAINT "Image_lessonRecordId_fkey" FOREIGN KEY ("lessonRecordId") REFERENCES "LessonRecord"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Video" ADD CONSTRAINT "Video_lessonRecordId_fkey" FOREIGN KEY ("lessonRecordId") REFERENCES "LessonRecord"("id") ON DELETE SET NULL ON UPDATE CASCADE;

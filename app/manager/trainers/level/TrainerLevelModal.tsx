...
import type { IAllTrainersForLevel } from "@/app/services/manager/manager-trainer.service";
...
const TrainerLevelModal = ({
  ...
  const { data: trainers, isLoading: trainersLoading } =
    useSWR<IAllTrainersForLevel>("/api/manager/trainers/level/trainers", fetcher);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = editingLevel
        ? `/api/manager/trainers/level/${editingLevel.id}`
        : "/api/manager/trainers/level";

    ...
    <div className="h-full container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">회원 또는 트레이너를 매니저로 변환합니다</p>
        </div>
      </div>
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="mt-4">
                ...
                {!actualSearchQuery.trim() && (
                  <div className="text-center py-8 text-gray-500">
                    사용자 이름을 입력하고 검색 버튼을 클릭하거나 Enter를 눌러주세요.
                  </div>
                )}
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="form-control">
                    ...
                    <div className="border rounded-lg p-4 max-h-60 overflow-y-auto bg-white">
                      {centers.length === 0 ? (
                        <p className="text-gray-500 text-sm">등록된 센터가 없습니다.</p>
                      ) : (
                        ...
                        <div className="mt-2 pt-2 border-t border-blue-200">
                          ...
                          <div className="space-y-1">
                            {selectedCenters.map((centerId) => {
                              ...
                              return center ? (
                                <div key={centerId} className="text-xs text-gray-700 pl-2">
                                  • {center.title}
                                </div>
                              ) : null;
                            })}
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-yellow-700 space-y-1">
                      <li>• 기존 {roleLabels[selectedUser.role]} 프로필은 유지됩니다.</li>
                      <li>• 매니저 권한으로 변경되어 시스템 관리가 가능해집니다.</li>
                      <li>• 변경 후에는 되돌릴 수 없으니 신중히 결정해주세요.</li>
                    </ul>
                  </div>
